...
export default {
    // DATALENS MODE
    serviceName: process.env.SERVICE_NAME || 'DataLens',
    ...
    regionalEnvConfig: {
        ...
        allowLanguages: [Language.Ru, Language.En],
    },
    ...
    apiPrefix: '/api',
    // charts-engine data-fetcher: без этого ctx.config.fetchingTimeout → DEFAULT 100s и pivot/MSSQL обрывается.
