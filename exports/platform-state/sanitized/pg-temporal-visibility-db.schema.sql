...
--
-- Name: convert_ts(character varying); Type: FUNCTION; Schema: public; Owner: pg-user
--
...
ALTER FUNCTION public.convert_ts(s character varying) OWNER TO "pg-user";
...
--
-- Name: executions_visibility; Type: TABLE; Schema: public; Owner: pg-user
--
...
CREATE TABLE public.executions_visibility (
    ...
    temporalpauseinfo jsonb GENERATED ALWAYS AS ((search_attributes -> 'TemporalPauseInfo'::text)) STORED,
    temporalworkerdeploymentversion character varying(255) GENERATED ALWAYS AS ((search_attributes ->> 'TemporalWorkerDeploymentVersion'::text)) STORED,
    temporalworkflowversioningbehavior character varying(255) GENERATED ALWAYS AS ((search_attributes ->> 'TemporalWorkflowVersioningBehavior'::text)) STORED,
    temporalworkerdeployment character varying(255) GENERATED ALWAYS AS ((search_attributes ->> 'TemporalWorkerDeployment'::text)) STORED,
    _version bigint DEFAULT 0 NOT NULL
);


ALTER TABLE public.executions_visibility OWNER TO "pg-user";
...
--
-- Name: executions_visibility executions_visibility_pkey; Type: CONSTRAINT; Schema: public; Owner: pg-user
--
...
--
-- Name: by_batcher_user; Type: INDEX; Schema: public; Owner: pg-user
--
...
--
-- Name: by_binary_checksums; Type: INDEX; Schema: public; Owner: pg-user
--
...
--
-- Name: by_bool_01; Type: INDEX; Schema: public; Owner: pg-user
--
...
--
-- Name: by_bool_02; Type: INDEX; Schema: public; Owner: pg-user
--
...
--
-- Name: by_bool_03; Type: INDEX; Schema: public; Owner: pg-user
--
...
--
-- Name: by_build_ids; Type: INDEX; Schema: public; Owner: pg-user
--
...
--
-- Name: by_datetime_01; Type: INDEX; Schema: public; Owner: pg-user
--
...
--
-- Name: by_datetime_02; Type: INDEX; Schema: public; Owner: pg-user
--
...
--
-- Name: by_datetime_03; Type: INDEX; Schema: public; Owner: pg-user
--
...
--
-- Name: by_double_01; Type: INDEX; Schema: public; Owner: pg-user
--
...
--
-- Name: by_double_02; Type: INDEX; Schema: public; Owner: pg-user
--
...
--
-- Name: by_double_03; Type: INDEX; Schema: public; Owner: pg-user
--
...
--
-- Name: by_execution_duration; Type: INDEX; Schema: public; Owner: pg-user
--

CREATE INDEX by_execution_duration ON public.executions_visibility USING btree (namespace_id, execution_duration, COALESCE(close_time, '9999-12-31 23:59:59'::timestamp without time zone) DESC, start_time DESC, run_id);


--
-- Name: by_execution_time; Type: INDEX; Schema: public; Owner: pg-user
--
...
--
-- Name: by_history_length; Type: INDEX; Schema: public; Owner: pg-user
--
...
--
-- Name: by_history_size_bytes; Type: INDEX; Schema: public; Owner: pg-user
--
...
--
-- Name: by_int_01; Type: INDEX; Schema: public; Owner: pg-user
--
...
--
-- Name: by_int_02; Type: INDEX; Schema: public; Owner: pg-user
--
...
--
-- Name: by_int_03; Type: INDEX; Schema: public; Owner: pg-user
--
...
--
-- Name: by_keyword_01; Type: INDEX; Schema: public; Owner: pg-user
--
...
--
-- Name: by_keyword_02; Type: INDEX; Schema: public; Owner: pg-user
--
...
--
-- Name: by_keyword_03; Type: INDEX; Schema: public; Owner: pg-user
--
...
--
-- Name: by_keyword_04; Type: INDEX; Schema: public; Owner: pg-user
--
...
--
-- Name: by_keyword_05; Type: INDEX; Schema: public; Owner: pg-user
--
...
--
-- Name: by_keyword_06; Type: INDEX; Schema: public; Owner: pg-user
--
...
--
-- Name: by_keyword_07; Type: INDEX; Schema: public; Owner: pg-user
--
...
--
-- Name: by_keyword_08; Type: INDEX; Schema: public; Owner: pg-user
--
...
--
-- Name: by_keyword_09; Type: INDEX; Schema: public; Owner: pg-user
--
...
--
-- Name: by_keyword_10; Type: INDEX; Schema: public; Owner: pg-user
--
...
--
-- Name: by_keyword_list_01; Type: INDEX; Schema: public; Owner: pg-user
--
...
--
-- Name: by_keyword_list_02; Type: INDEX; Schema: public; Owner: pg-user
--
...
--
-- Name: by_keyword_list_03; Type: INDEX; Schema: public; Owner: pg-user
--
...
--
-- Name: by_parent_run_id; Type: INDEX; Schema: public; Owner: pg-user
--

CREATE INDEX by_parent_run_id ON public.executions_visibility USING btree (namespace_id, parent_run_id, COALESCE(close_time, '9999-12-31 23:59:59'::timestamp without time zone) DESC, start_time DESC, run_id);


--
-- Name: by_parent_workflow_id; Type: INDEX; Schema: public; Owner: pg-user
--

CREATE INDEX by_parent_workflow_id ON public.executions_visibility USING btree (namespace_id, parent_workflow_id, COALESCE(close_time, '9999-12-31 23:59:59'::timestamp without time zone) DESC, start_time DESC, run_id);


--
-- Name: by_root_run_id; Type: INDEX; Schema: public; Owner: pg-user
--

CREATE INDEX by_root_run_id ON public.executions_visibility USING btree (namespace_id, root_run_id, COALESCE(close_time, '9999-12-31 23:59:59'::timestamp without time zone) DESC, start_time DESC, run_id);


--
-- Name: by_root_workflow_id; Type: INDEX; Schema: public; Owner: pg-user
--

CREATE INDEX by_root_workflow_id ON public.executions_visibility USING btree (namespace_id, root_workflow_id, COALESCE(close_time, '9999-12-31 23:59:59'::timestamp without time zone) DESC, start_time DESC, run_id);


--
-- Name: by_state_transition_count; Type: INDEX; Schema: public; Owner: pg-user
--

CREATE INDEX by_state_transition_count ON public.executions_visibility USING btree (namespace_id, state_transition_count, COALESCE(close_time, '9999-12-31 23:59:59'::timestamp without time zone) DESC, start_time DESC, run_id);


--
-- Name: by_status; Type: INDEX; Schema: public; Owner: pg-user
--
...
--
-- Name: by_task_queue; Type: INDEX; Schema: public; Owner: pg-user
--
...
--
-- Name: by_temporal_change_version; Type: INDEX; Schema: public; Owner: pg-user
--
...
--
-- Name: by_temporal_namespace_division; Type: INDEX; Schema: public; Owner: pg-user
--
...
--
-- Name: by_temporal_pause_info; Type: INDEX; Schema: public; Owner: pg-user
--

CREATE INDEX by_temporal_pause_info ON public.executions_visibility USING gin (namespace_id, temporalpauseinfo jsonb_path_ops);


--
-- Name: by_temporal_schedule_paused; Type: INDEX; Schema: public; Owner: pg-user
--
...
--
-- Name: by_temporal_scheduled_by_id; Type: INDEX; Schema: public; Owner: pg-user
--
...
--
-- Name: by_temporal_scheduled_start_time; Type: INDEX; Schema: public; Owner: pg-user
--
...
--
-- Name: by_temporal_worker_deployment; Type: INDEX; Schema: public; Owner: pg-user
--

CREATE INDEX by_temporal_worker_deployment ON public.executions_visibility USING btree (namespace_id, temporalworkerdeployment, COALESCE(close_time, '9999-12-31 23:59:59'::timestamp without time zone) DESC, start_time DESC, run_id);


--
-- Name: by_temporal_worker_deployment_version; Type: INDEX; Schema: public; Owner: pg-user
--

CREATE INDEX by_temporal_worker_deployment_version ON public.executions_visibility USING btree (namespace_id, temporalworkerdeploymentversion, COALESCE(close_time, '9999-12-31 23:59:59'::timestamp without time zone) DESC, start_time DESC, run_id);


--
-- Name: by_temporal_workflow_versioning_behavior; Type: INDEX; Schema: public; Owner: pg-user
--

CREATE INDEX by_temporal_workflow_versioning_behavior ON public.executions_visibility USING btree (namespace_id, temporalworkflowversioningbehavior, COALESCE(close_time, '9999-12-31 23:59:59'::timestamp without time zone) DESC, start_time DESC, run_id);


--
-- Name: by_text_01; Type: INDEX; Schema: public; Owner: pg-user
--
...
--
-- Name: by_text_02; Type: INDEX; Schema: public; Owner: pg-user
--
...
--
-- Name: by_text_03; Type: INDEX; Schema: public; Owner: pg-user
--
...
--
-- Name: by_workflow_id; Type: INDEX; Schema: public; Owner: pg-user
--
...
--
-- Name: by_workflow_type; Type: INDEX; Schema: public; Owner: pg-user
--
...
--
-- Name: default_idx; Type: INDEX; Schema: public; Owner: pg-user
--
