...
/** Size for table visualizations (pivot / flat table) in chart settings: S, M, L */
...
export default class ChartSettings {
    ...
    private tableSizeBlockSelector = '.wizard-chart-settings__widget-size';
    ...
    /** Select table size (S/M/L) for pivot or flat table. Call after open(). */
    async selectTableSize(size: TableSize) {
        const option = this.page
            .locator(this.tableSizeBlockSelector)
