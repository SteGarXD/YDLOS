...
const mapV4ConfigToV5 = (config) => {
    var _a, _b;
    const migratedConfig = { ...config, version: versions_1.QlConfigVersions.V5 };
    if (((_a = config.visualization) === null || _a === void 0 ? void 0 : _a.id) === constants_1.QlVisualizationId.Metric &&
    ...
    else if (((_b = config.visualization) === null || _b === void 0 ? void 0 : _b.id) === constants_1.QlVisualizationId.FlatTable &&
