...
const get_gradient_stops_1 = require("../get-gradient-stops");
describe('getGradientStops', () => {
    ...
    describe('three point gradient, manual thresholds', () => {
        const colorsConfig = {
            ...
            gradientMode: shared_1.GradientType.THREE_POINT,
            availablePalettes: {},
            loadedColorPalettes: {},
        ...
        testsArgs.forEach((testArgs) => {
            var _a;
            const values = (_a = testArgs === null || testArgs === void 0 ? void 0 : testArgs.points) !== null && _a !== void 0 ? _a : points;
            const minColorValue = Math.min(...values);
            const maxColorValue = Math.max(...values);
            it(testArgs.title, () => {
                const result = (0, get_gradient_stops_1.getHighchartsGradientStops)({
    ...
    describe('two point gradient, manual thresholds', () => {
        const colorsConfig = {
            ...
            gradientMode: shared_1.GradientType.TWO_POINT,
            availablePalettes: {},
            loadedColorPalettes: {},
            thresholdsMode: 'manual',
        };
