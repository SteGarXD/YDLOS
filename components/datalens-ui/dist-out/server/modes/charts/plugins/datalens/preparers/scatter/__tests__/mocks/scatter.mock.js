...
exports.scatterPrepareForQLResult = exports.scatterPrepareForQLArgs = exports.scatterPrepareBaseArgs = exports.shapeField = exports.colorField = void 0;
...
exports.scatterPrepareBaseArgs = {
    ChartEditor: {
        getWidgetConfig: () => { },
    },
    colors: [],
    ...
    resultData: {
        ...
        order: [xField, yField, exports.shapeField, exports.colorField],
        totals: [],
    },
    features: [],
    shared: {},
};
exports.scatterPrepareForQLArgs = {
    placeholders: [
        {
            allowedTypes: {},
            allowedDataTypes: {},
...
exports.scatterPrepareForQLResult = {
    graphs: [
        {
            data: [
