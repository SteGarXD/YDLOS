...
const old_pivot_table_1 = __importDefault(require("../old-pivot-table"));
const { baseCase1, baseCase2, baseCase3, baseCase4, baseCase5, baseCase6, baseCase7, baseCase8, baseCase9, baseCase10, baseCase11, baseCase12, baseCase13, baseCase14, preparingGrouppedMarkupDataWith1ColumnLevel, preparingGrouppedMarkupDataWith2ColumnLevel, preparingPivotTableWithEmptyAndNullValues, preparingSortedTable, preparingDataWithShiftedMeasureNames, preparingDataWithDataByNullKeys, } = require('./mocks/old-pivot-table.mock');
describe('pivot-table', () => {
    test('base case 1', () => {
        const result = (0, old_pivot_table_1.default)(baseCase1);
    ...
    test('base case 2', () => {
        const result = (0, old_pivot_table_1.default)(baseCase2);
    ...
    test('base case 3', () => {
        const result = (0, old_pivot_table_1.default)(baseCase3);
    ...
    test('base case 4', () => {
        const result = (0, old_pivot_table_1.default)(baseCase4);
    ...
    test('base case 5', () => {
        const result = (0, old_pivot_table_1.default)(baseCase5);
    ...
    test('base case 6', () => {
        const result = (0, old_pivot_table_1.default)(baseCase6);
        expect(result.head.length).toEqual(2);
        expect(result.rows.length).toEqual(4);
    ...
    test('base case 7', () => {
        const result = (0, old_pivot_table_1.default)(baseCase7);
        expect(result.head.length).toEqual(4);
        expect(result.rows.length).toEqual(4);
    ...
    test('base case 8', () => {
        const result = (0, old_pivot_table_1.default)(baseCase8);
        expect(result.head.length).toEqual(4);
        expect(result.rows.length).toEqual(4);
        expect(result.head[1].name).toEqual('Consumer');
        expect(result.rows[0].cells[0].value).toEqual('First Class');
    ...
    test('base case 9', () => {
        const result = (0, old_pivot_table_1.default)(baseCase9);
        expect(result.head.length).toEqual(4);
        expect(result.rows.length).toEqual(4);
        expect(result.head[1].name).toEqual('Consumer');
        expect(result.rows[0].cells[0].value).toEqual('First Class');
        expect(result.rows[0].cells[1].css.backgroundColor.replace(/\s/g, '')).toEqual('rgb(27,94,181)');
        expect(result.rows[0].cells[3].css.backgroundColor.replace(/\s/g, '')).toEqual('rgb(12,80,171)');
        expect(result.rows[3].cells[1].css.backgroundColor.replace(/\s/g, '')).toEqual('rgb(140,203,255)');
        expect(result.rows[3].cells[3].css.backgroundColor.replace(/\s/g, '')).toEqual('rgb(44,110,191)');
    });
    test('base case 10', () => {
        const result = (0, old_pivot_table_1.default)(baseCase10);
        expect(result.head.length).toEqual(4);
        expect(result.rows.length).toEqual(4);
        expect(result.head[1].name).toEqual('Consumer');
        expect(result.rows[0].cells[0].value).toEqual('First Class');
    ...
    test('base case 11', () => {
        const result = (0, old_pivot_table_1.default)(baseCase11);
        expect(result.head.length).toEqual(5);
    ...
    test('base case 12', () => {
        const result = (0, old_pivot_table_1.default)(baseCase12);
        expect(result.head.length).toEqual(4);
    ...
    test('base case 13', () => {
        const result = (0, old_pivot_table_1.default)(baseCase13);
        expect(result.head.length).toEqual(3);
        expect(result.rows.length).toEqual(176);
    });
    test('base case 14', () => {
        const result = (0, old_pivot_table_1.default)(baseCase14);
        expect(result.head.length).toEqual(4);
        expect(result.head[1].sub.length).toEqual(39);
        expect(result.rows.length).toEqual(1);
    });
    test('should prepare 10+1 columns and 2 rows table', () => {
        const result = (0, old_pivot_table_1.default)(preparingGrouppedMarkupDataWith1ColumnLevel);
        expect(result.head.length).toEqual(11);
        expect(result.rows.length).toEqual(2);
    });
    test('should prepare 2+1 columns and 9 rows table', () => {
        const result = (0, old_pivot_table_1.default)(preparingGrouppedMarkupDataWith2ColumnLevel);
        expect(result.head.length).toEqual(3);
        expect(result.rows.length).toEqual(9);
    });
    test('should sort dates ascending and order status ascending', () => {
        const result = (0, old_pivot_table_1.default)(preparingSortedTable);
    ...
    test('should prepare table with null and empty string values', () => {
        const result = (0, old_pivot_table_1.default)(preparingPivotTableWithEmptyAndNullValues);
        expect(result.head.length).toEqual(3);
    ...
    test('should prepare table with shifted measure names correctly', () => {
        const result = (0, old_pivot_table_1.default)(preparingDataWithShiftedMeasureNames);
        expect(result.head.length).toEqual(6);
    ...
    test('should prepare table with data by null keys', () => {
        const result = (0, old_pivot_table_1.default)(preparingDataWithDataByNullKeys);
        expect(result.head.length).toEqual(3);
