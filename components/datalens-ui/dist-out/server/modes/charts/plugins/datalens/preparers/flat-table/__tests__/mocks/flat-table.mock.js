...
exports.flatTablePrepareWithTotalsArgs = exports.flatTableFormattingFloatPrecisionArgs = exports.flatTableFormattingIntPrecisionArgs = void 0;
const i18nMock = {
    I18n: {
        keyset: (_str) => {
...
const getTranslation = (keyset, key, params) => i18nMock.I18n.keyset(keyset)(key, params);
...
exports.flatTableFormattingIntPrecisionArgs = {
    ...baseArgs,
...
exports.flatTableFormattingFloatPrecisionArgs = {
    ...baseArgs,
...
exports.flatTablePrepareWithTotalsArgs = {
    ...baseArgs,
    placeholders: [
        {
            items: [
