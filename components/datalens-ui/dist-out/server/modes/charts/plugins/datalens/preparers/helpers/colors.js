...
exports.interpolateRgbBasis = interpolateRgbBasis;
...
function spline(colorValues) {
    ...
    return function (value) {
        const i = value <= 0
            ...
            : value >= 1
                ? ((value = 1), n - 1)
                : Math.floor(value * n), v1 = colorValues[i], v2 = colorValues[i + 1], v0 = i > 0 ? colorValues[i - 1] : 2 * v1 - v2, v3 = i < n - 1 ? colorValues[i + 2] : 2 * v2 - v1;
