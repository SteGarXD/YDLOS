...
const normalizeParamsTestData = {
    ...
    test2: {
        in: {
            param1: '1',
            param2: ['2'],
            [`${shared_1.URL_ACTION_PARAMS_PREFIX}param3`]: '3',
            [`${shared_1.URL_ACTION_PARAMS_PREFIX}param4`]: ['4'],
        },
        out: {
            params: {
                param1: ['1'],
...
describe('Charts Engine utils', () => {
    ...
    test('normalizeParams different cases', () => {
        const res = (0, utils_1.normalizeParams)();
        expect(res.params).toEqual({});
        expect(res.actionParams).toEqual({});
        const res1 = (0, utils_1.normalizeParams)(normalizeParamsTestData.test1.in);
        ...
        const res2 = (0, utils_1.normalizeParams)(normalizeParamsTestData.test2.in);
        ...
        const res3 = (0, utils_1.normalizeParams)(normalizeParamsTestData.test3.in);
