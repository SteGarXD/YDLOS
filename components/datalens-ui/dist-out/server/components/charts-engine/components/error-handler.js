...
function createErrorHandler({ meta = {}, rethrow = true }) {
    const defaultRetrhow = rethrow;
    const defaultMeta = meta;
    return function handleError({ code = '', message: inputMessage = '', error: inputError, meta = {}, rethrow = defaultRetrhow, // eslint-disable-line no-shadow
     }) {
