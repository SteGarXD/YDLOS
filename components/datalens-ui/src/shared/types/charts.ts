...
const _REQUIRED_THEME_VALUES = ['dark', 'light'] as const;
const _OPTIONAL_THEME_VALUES = ['dark-hc', 'light-hc'] as const;
type RequiredThemes = Record<(typeof _REQUIRED_THEME_VALUES)[number], Record<string, string>>;
type OptionalThemes = Partial<
    Record<(typeof _OPTIONAL_THEME_VALUES)[number], Record<string, string>>
>;
