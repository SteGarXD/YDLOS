...
export type CommonSharedExtraSettings = {
    ...
    flatTableRowTree?: ServerCommonSharedExtraSettings['flatTableRowTree'];
    customizationProfileId?: string;
    customization?: ServerCommonSharedExtraSettings['customization'];
} & MetricFontSettings;
