...
export type DatasetSourceInfo = {
    ...
    /** Optional label field guid: show label from this field while keeping value as `datasetFieldId`. */
    datasetLabelFieldId?: string;
    /** Field guid used for search (ICONTAINS) in getDistincts; defaults to `datasetFieldId`. */
    datasetSearchFieldId: string;
