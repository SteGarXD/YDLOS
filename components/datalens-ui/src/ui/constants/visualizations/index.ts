...
import {GAUGE_VISUALIZATION} from './gauge';
...
export const VISUALIZATIONS_BY_ID = {
    ...
    [GAUGE_VISUALIZATION.id]: GAUGE_VISUALIZATION,
    ...
    [BAR_Y_D3_VISUALIZATION.id]: BAR_Y_D3_VISUALIZATION,
    [BAR_Y_100P_D3_VISUALIZATION.id]: BAR_Y_100P_D3_VISUALIZATION,
    [LINE_D3_VISUALIZATION.id]: LINE_D3_VISUALIZATION,
    [DONUT_D3_VISUALIZATION.id]: DONUT_D3_VISUALIZATION,
    [TREEMAP_D3_VISUALIZATION.id]: TREEMAP_D3_VISUALIZATION,
};
