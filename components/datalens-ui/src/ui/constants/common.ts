...
import type {AppInstallation, LineShapeType} from '../../shared';
import {
    AppEnvironment,
    DeviceType,
    ErrorContentTypes,
...
import logoAeronavigatorSvg from '../assets/icons/logo-aeronavigator.svg';
...
/** URL логотипа: bundled SVG (PNG из datalens/assets опционально через copy-public-assets) */
export const LOGO_PNG_URL = logoAeronavigatorSvg;
...
export const DL = {
    ...
    get installationType(): AppInstallation {
        return window.DL.installationType;
    },
    get IS_MOBILE() {
