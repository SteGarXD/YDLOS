...
/** workbookId / collectionId со страницы создания (маршрут), чтобы API шли с X-DL-Workbook-Id */
export const SET_DATASET_CREATION_CONTEXT = Symbol('dataset/SET_DATASET_CREATION_CONTEXT');
