...
/** Сохраняет workbookId из маршрута `/workbooks/:id/datasets/new` в store — для заголовка X-DL-Workbook-Id в BI/US. */
export function setDatasetCreationContext(payload: {workbookId: WorkbookId | null}) {
    return {
        type: DATASET_ACTION_TYPES.SET_DATASET_CREATION_CONTEXT,
        payload,
    };
}
