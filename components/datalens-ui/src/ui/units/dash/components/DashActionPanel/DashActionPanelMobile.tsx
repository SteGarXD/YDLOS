...
import {FlightGroupsEditorButton} from '../FlightGroupsEditor/FlightGroupsEditorButton';
            ...
            <div className={b()}>
                ...
                {showControls && (
                    <div className={b('controls')}>
                        <FlightGroupsEditorButton dashData={entry.data} variant="mobile-inline" />
                        {this.renderControls(entry.entryId)}
                    </div>
                )}
            </div>
        );
