...
import {
    BUMP_FLIGHT_GROUPS_DATASET_REFRESH,
...
export type DashState = {
    ...
    /** См. dash.js — синхронизация списков селекторов после редактора групп рейсов */
...
export function dashTypedReducer(
    ...
    switch (action.type) {
        ...
        case BUMP_FLIGHT_GROUPS_DATASET_REFRESH: {
            return {
                ...state,
                flightGroupsDatasetRefreshNonce: (state.flightGroupsDatasetRefreshNonce ?? 0) + 1,
            };
        }
