...
export const AXIS_ORDER_RADIO_BUTTON_OPTIONS: SegmentedRadioGroupOptionProps[] = [
    {
        value: SETTINGS.AXIS_ORDER.ASC,
        content: i18n('wizard', 'label_axis-order-asc'),
    },
    {
        value: SETTINGS.AXIS_ORDER.DESC,
        content: i18n('wizard', 'label_axis-order-desc'),
    },
];
