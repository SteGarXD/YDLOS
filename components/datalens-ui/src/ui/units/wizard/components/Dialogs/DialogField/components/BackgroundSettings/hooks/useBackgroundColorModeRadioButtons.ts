...
export const useBackgroundColorModeRadioButtons = ({
    ...
    // YDL OS: для мер в сводной — Палитра видима, но недоступна (выбор только Градиент; цвета задаются стилем ячеек: Светофор/Бирюзовый)
    ...
    }, [field, isPlaceholderWithPaletteOnlyMode, isPivotMeasures]);
