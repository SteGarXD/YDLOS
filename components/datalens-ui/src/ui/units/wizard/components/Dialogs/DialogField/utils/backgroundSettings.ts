...
export const extractGradientSettings = (
    ...
    useGradient: (gradientState as GradientState).useGradient,
    discreteColorLow: (gradientState as GradientState).discreteColorLow,
    discreteColorMid: (gradientState as GradientState).discreteColorMid,
    discreteColorHigh: (gradientState as GradientState).discreteColorHigh,
});
