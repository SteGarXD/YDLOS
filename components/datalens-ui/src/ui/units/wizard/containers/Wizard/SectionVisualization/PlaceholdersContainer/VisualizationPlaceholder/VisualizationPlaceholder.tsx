...
class VisualizationPlaceholder extends React.Component<Props> {
    ...
    private openDialogColumnSettings = () => {
        ...
        this.props.openDialogColumnSettings({
            ...
            flatTableRowTree: extraSettings?.flatTableRowTree,
        });
    };
    ...
    private handleDialogColumnSettingsApply = (
        ...
        const nextExtra = {...this.props.extraSettings, pinnedColumns};
        if (visualization.id === WizardVisualizationId.FlatTable) {
            if (flatTableRowTree) {
                nextExtra.flatTableRowTree = flatTableRowTree;
            } else {
                delete nextExtra.flatTableRowTree;
            }
        }

        this.props.setExtraSettings(nextExtra);
