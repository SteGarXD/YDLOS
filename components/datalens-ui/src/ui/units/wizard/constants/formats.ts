...
const AVAILABLE_DATE_FORMATS_NON_TABLE = ['DD.MM.YYYY', 'YYYY-MM-DD', 'DD-MM-YYYY'];
...
const AVAILABLE_DATETIME_FORMATS_NON_TABLE = [
    'DD.MM.YYYY HH:mm:ss',
    'YYYY-MM-DD HH:mm:ss',
    'DD-MM-YYYY HH:mm:ss',
];
...
const AVAILABLE_DATETIMETZ_FORMATS_NON_TABLE = [
    'DD.MM.YYYY HH:mm:ss Z',
    'YYYY-MM-DD HH:mm:ss Z',
    'DD-MM-YYYY HH:mm:ss Z',
];
