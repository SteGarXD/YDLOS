...
class SDK {
    ...
    getHeaders() {
        ...
        // OpenSource/dev: direct browser -> data-api requests may need US master token for US entry reads.
        if (process.env.US_MASTER_TOKEN) {
            headers[US_MASTER_TOKEN_HEADER] = process.env.US_MASTER_TOKEN;
        }
