...
import {
    getFlatTableRowTreeCollapseAllMenuItem,
    getFlatTableRowTreeExpandAllMenuItem,
} from './flatTableRowTreeMenuItems';
...
export const getDefaultChartMenu = ({
    ...
    const menuItemsGroups: (MenuItemConfig | null)[] = [
        ...
        getLinkMenuItem(customOptions[MenuItemsIds.GET_LINK]),
    ];
