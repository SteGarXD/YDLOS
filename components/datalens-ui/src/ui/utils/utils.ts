...
export default class Utils {
    ...
    static setRpcAuthorization() {
        ...
        const token: any = params.get('x-rpc-authorization');
    ...
    static getAuthToken = async (propsData: any) => {
        const result = await getSdk().sdk.us.getAuth({
            login: propsData.login,
    ...
    static getEmbedToken = async (propsData: any) => {
        const workbookId = await this.decodeId({id: propsData.workbookId || propsData.id});
        const entryId = await this.decodeId({id: propsData.entryId || propsData.id});

        const result = await this.universalService({
            action: 'datalens',
            method: 'embed',
            data: [{workbookId: workbookId, entryId: entryId, reject: propsData.reject}],
        });
    ...
    static encodeId = async (propsData: any) => {
        const result = await getSdk().sdk.us.encodeId({id: propsData.id});

        return result.id;
    };

    static decodeId = async (propsData: any) => {
        const result = await getSdk().sdk.us.decodeId({id: propsData.id});
    ...
    static setAccesses = async (propsData: any) => {
        const result = await this.universalService({
            ...
            data: Array.isArray(propsData) ? propsData : [propsData],
        });
    ...
    static createUser = async (propsData: any) => {
        return await this.universalService({
            action: 'datalens',
            method: 'create_user',
            data: [propsData],
        });
    ...
    static universalService = async (propsData: any) => {
        const result = await getSdk().sdk.us.universalService(propsData);
