...
import {
    flightGroupsEditorConfig,
    flightGroupsEditorFlightAdd,
    flightGroupsEditorFlightRemove,
    flightGroupsEditorFlightsIn,
    flightGroupsEditorFlightsOut,
    flightGroupsEditorGroupCreate,
    flightGroupsEditorGroupDelete,
    flightGroupsEditorGroupUpdate,
    flightGroupsEditorGroupsList,
} from '../../controllers/flight-groups-editor';
...
export function getRoutes({
    ...
    const routeParams = {beforeAuth, afterAuth};
    // Opensource: auth-маршруты первыми, чтобы не перехватывались postGateway (иначе 404 / Unknown service)
    let routes: Record<string, ExtendedAppRouteDescription> = {
        ...getAuthRoutes({routeParams}),
        ping: {
            beforeAuth: [],
            afterAuth: [],
            route: 'GET /ping',
        ...
        flightGroupsEditorConfig: {
            beforeAuth,
            afterAuth,
            route: 'GET /api/flight-groups-editor/config',
            handler: flightGroupsEditorConfig,
        },
        flightGroupsEditorGroupsList: {
            beforeAuth,
            afterAuth,
            route: 'GET /api/flight-groups-editor/groups',
            handler: flightGroupsEditorGroupsList,
        },
        flightGroupsEditorGroupCreate: {
            beforeAuth,
            afterAuth,
            route: 'POST /api/flight-groups-editor/groups',
            handler: flightGroupsEditorGroupCreate,
        },
        flightGroupsEditorGroupUpdate: {
            beforeAuth,
            afterAuth,
            route: 'PATCH /api/flight-groups-editor/groups/:id',
            handler: flightGroupsEditorGroupUpdate,
        },
        flightGroupsEditorGroupDelete: {
            beforeAuth,
            afterAuth,
            route: 'DELETE /api/flight-groups-editor/groups/:id',
            handler: flightGroupsEditorGroupDelete,
        },
        flightGroupsEditorFlightsIn: {
            beforeAuth,
            afterAuth,
            route: 'GET /api/flight-groups-editor/groups/:groupId/flights-in',
            handler: flightGroupsEditorFlightsIn,
        },
        flightGroupsEditorFlightsOut: {
            beforeAuth,
            afterAuth,
            route: 'GET /api/flight-groups-editor/groups/:groupId/flights-out',
            handler: flightGroupsEditorFlightsOut,
        },
        flightGroupsEditorFlightAdd: {
            beforeAuth,
            afterAuth,
            route: 'POST /api/flight-groups-editor/groups/:groupId/flights',
            handler: flightGroupsEditorFlightAdd,
        },
        flightGroupsEditorFlightRemove: {
            beforeAuth,
            afterAuth,
            route: 'DELETE /api/flight-groups-editor/groups/:groupId/flights/:flightNo',
            handler: flightGroupsEditorFlightRemove,
        },
    };
