...
export const config = {
    ...
    // 300 seconds (raised for large exports / heavy dashboards)
    DEFAULT_FETCHING_TIMEOUT: 300 * 1000,

    // 290 seconds
    DEFAULT_SINGLE_FETCHING_TIMEOUT: 290 * 1000,

    // 8000 MB (raised for open-source / on-prem)
    ALL_REQUESTS_SIZE_LIMIT: 8000 * 1e6,

    // 4000 MB
    REQUEST_SIZE_LIMIT: 4000 * 1e6,
